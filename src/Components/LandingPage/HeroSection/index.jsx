    ...
    backgroundRepeat: 'no-repeat',
      ...
      <div className="relative z-10 flex flex-wrap lg:flex-row items-center justify-around px-10 pt-50 pb-20">
        <div className="max-w-xl mb-16 lg:mb-0 animate__animated animate__backInLeft">
          <h1 className="text-black text-[40px] lg:text-[50px] font-bold leading-tight">
            Budget with a why
          </h1>
          <p className="text-black text-[18px] lg:text-[20px] font-normal mt-5">
            Spend, save, and give toward what's important in life
          </p>
          <Button
            text={"Start your Free Trial"}
            classStyle={
              "px-5 py-2 rounded-[10px] bg-green-400 text-white font-semibold hover:bg-green-600 transition-colors duration-300 mt-5"
            }
          />
          <p className="text-black text-[18px] lg:text-[20px] font-normal mt-5">
