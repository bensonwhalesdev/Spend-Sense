    ...
    <div className="relative bg-[#E9E9EF] rounded-br-[200px] overflow-hidden opacity-90">
      ...
      <div className="relative z-10 flex flex-wrap lg:flex-row items-center justify-around px-10 pt-50 pb-20">
        <div className="max-w-xl mb-16 lg:mb-0 animate__animated animate__backInLeft">
          <h1 className="text-black text-[40px] lg:text-[50px] font-bold leading-tight animate__animated animate__fadeInLeft">Budget with a why</h1>
        ...
        <div className="mt-10 lg:mt-0 animate__animated animate__fadeInRight"><SignUp /></div>
      </div>
    </div>
  )
}
