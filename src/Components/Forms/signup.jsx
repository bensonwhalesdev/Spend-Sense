    ...
    <div className="w-[500px] rounded-[10px] bg-[#1C1F58] px-5 py-11 text-black shadow-[0_5px_15px_#00000059] float-animation">
      <form action="" className="relative flex flex-col items-center gap-7">
        ...
        <div className="relative ml-[-15px] w-full">
          ...
          <input id="firstname" type="text" placeholder="First Name" required className="w-full rounded-md border border-solid border-black bg-white px-2.5 py-[15px] text-black placeholder:text-black outline-none focus:border-black"/>
        </div>
        ...
        <div className="relative ml-[-15px] w-full">
          ...
          <input id="lastname" type="text" placeholder="Last Name" required className="w-full rounded-md border border-solid border-black bg-white px-2.5 py-[15px] text-black placeholder:text-black outline-none focus:border-black"/>
        </div>
        ...
        <div className="relative ml-[-15px] w-full">
          ...
          <input id="password" type="password" placeholder="Password" required className="w-full rounded-md border border-solid border-black bg-white px-2.5 py-[15px] text-black placeholder:text-black outline-none focus:border-black"/>
        </div>
        ...
        <div className="relative ml-[-15px] w-full">
          ...
          <input id="confirm-password" type="password" placeholder="Confirm Password" required className="w-full rounded-md border border-solid border-black bg-white px-2.5 py-[15px] text-black placeholder:text-black outline-none focus:border-black" />
        </div>
