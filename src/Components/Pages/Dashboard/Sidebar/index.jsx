import { Home, PieChart, Wallet, PlusCircle, ChevronDown, Trash2 } from "lucide-react";
    ...
    <div className="w-[20%] min-h-screen bg-[#12134C] text-white p-4 flex flex-col gap-6">
      ...
      <nav className="flex flex-col gap-3">
        <button className="flex items-center gap-3 p-2 rounded bg-[#2E3092]">
          <Home className="w-5 h-5" /> <span>Plan</span>
        </button>
        <button className="flex items-center gap-3 p-2 hover:bg-[#2E3092] rounded">
          <PieChart className="w-5 h-5" /> <span>Reflect</span>
        </button>
        <button className="flex items-center gap-3 p-2 hover:bg-[#2E3092] rounded">
          <Wallet className="w-5 h-5" /> <span>All Accounts</span>
        </button>
      </nav>
