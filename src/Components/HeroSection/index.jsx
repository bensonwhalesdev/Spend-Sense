...
const HeroSection = () => {
  return (
    <div className="relative bg-[#fff] rounded-br-[200px]">
      <div className="absolute top-20 w-full h-[100px] bg-[#1C1F58] clip-v-shape"></div>

      <div className='h-[90vh]'>
         <div className='absolute top-60 p-10'>
          <h1 className='text-[#000] text-[50px] font-bold'>Budget with a why</h1>
          <p className='text-[#000] text-[20px] font-normal mt-5'>Spend, save, and give toward what's important in life</p>
