    ...
    <div className="w-[500px] rounded-[10px] bg-[#1C1F58] px-5 py-4 text-black shadow-[#1C1F58] shadow-lg hover:shadow-2xl float-animation">
      <form onSubmit={submitHandler} className="relative flex flex-col items-center gap-7">
        ...
        <div className="relative ml-[-15px] w-full">
          <label htmlFor="firstname" className="absolute left-0 top-[-22px] cursor-text bg-[#1C1F58] px-1 pb-0 pt-2.5 text-sm text-white">First Name</label>
        ...
        <div className="relative ml-[-15px] w-full">
          <label htmlFor="lastname" className="absolute left-0 top-[-22px] cursor-text bg-[#1C1F58] px-1 pb-0 pt-2.5 text-sm text-white">Last Name</label>
